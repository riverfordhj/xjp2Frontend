<template>
	<div>
	  <div class="toolbar">
		...
		<el-table
			:data="filterData" height="900" border	style="width: 100%">
			...
			<el-table-column prop="registrationPlace" label="注册地址" width="180">
			</el-table-column>
			...
			<el-table-column prop="legalRepresentative" label="公司法人代表" width="180">
			</el-table-column>
			...
			<el-table-column prop="enterpriseBackground" label="企业背景" width="180">
			</el-table-column>
			...
			<el-table-column prop="taxStatisticsArea" label="税收统计区" width="180">
			</el-table-column>
