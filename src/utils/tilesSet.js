/*
 * @Descripttion: for Cesium
 * @version: 1
 * @Author: KanMing
 * @Date: 2019-09-24 15:43:55
 * @LastEditors: KanMing
 * @LastEditTime: 2019-09-26 10:48:33
 */
  ...
  install: function (viewer) {
    ...
    this.onMouseMove = function (movement) {
      ...
      if (!Cesium.defined(name)) {
        name = pickedFeature.getProperty('新编号')
      }
      if (!Cesium.defined(name)) {
...
// 加载 3dTiles 模型
function add3dTiles (viewer, url, type) {
  var tileset
  if (type === 'tiles') {
...
export { add3dTiles, adjust3dTilesPosition, rotationAndScale, featureViewer }
